...
public class ManageGroupAddUsersForm extends ActionForm{
	...
	/**
	 * Get the Users that are already not in the group
	 */	
	public void reset(ActionMapping mapping, HttpServletRequest request) {
			...
			try {
				usersNotInGroup = controllerConnection.getAllUsersNotInGroup(((GroupMars)request.getSession().getAttribute("selectedGroup")).getId());
